...
// Fetch user info
$stmt = $conn->prepare("SELECT u.first_name,u.middle_name,u.last_name,u.email,u.created_at,u.is_banned,
                               p.phone,p.address,p.avatar,p.display_name
                        FROM users u 
...
<head>
  ...
  <style>
    ...
    .table th { width: 25%; vertical-align: middle; }
...
```
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
    <h3 class="fw-bold text-danger mb-3 mb-md-0">👤 User Profile</h3>
    <a href="manage_users.php" class="btn btn-outline-danger fw-semibold">← Back to Users</a>
  </div>

  <!-- Profile Card -->
  <div class="card shadow-sm border-0">
    <div class="card-header bg-danger text-white fw-bold">User Information</div>
